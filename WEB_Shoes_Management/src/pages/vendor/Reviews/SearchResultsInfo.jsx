...
import { FiMessageSquare, FiFilter, FiTrendingUp, FiCheckCircle } from 'react-icons/fi'

export const SearchResultsInfo = ({ totalItems, currentPage, limit, activeFiltersCount }) => {
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <div className="w-9 h-9 rounded-xl bg-brand-primary/10 flex items-center justify-center">
                <FiMessageSquare className="text-brand-primary" size={16} />
              </div>
              <div>
