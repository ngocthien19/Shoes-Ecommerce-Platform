...
import { FiCheckSquare, FiTrash2, FiEye, FiEyeOff, FiRefreshCw, FiX } from 'react-icons/fi'

export const BulkActionPanel = ({ selectedCount, onBulkAction, onClearSelection }) => {
  ...
  return (
    ...
    >
      ...
      {/* Các nút xử lý dữ liệu có Transition Hover mượt mà */}
      <div className="flex flex-wrap items-center gap-2.5 w-full sm:w-auto justify-end">
        ...
        >
          <FiEyeOff size={14} /> Tạm ẩn
        </button>
        <button
          onClick={() => onBulkAction('reapprove')}
          className="flex items-center gap-1.5 bg-orange-50 hover:bg-orange-500 text-orange-600 hover:text-white border border-orange-200 px-4 py-2.5 rounded-xl text-xs font-bold cursor-pointer active:scale-95 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:shadow-md hover:shadow-orange-500/20"
        >
          <FiRefreshCw size={14} /> Gửi yêu cầu duyệt
        </button>
        <button
