...
import { FiTag, FiFilter, FiTrendingUp } from 'react-icons/fi'

export const PromotionSearchResultsInfo = ({ totalItems, currentPage, limit, activeFiltersCount }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 w-24 h-24 bg-green-500/5 rounded-full blur-2xl translate-y-1/2 -translate-x-1/2 pointer-events-none" />
          ...
          <div className="flex items-center gap-4">
            <motion.div variants={itemVariants} className="flex items-center gap-2">
              <div className="w-9 h-9 rounded-xl bg-brand-primary/10 flex items-center justify-center">
                <FiTag className="text-brand-primary" size={16} />
              </div>
              <div>
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Tổng số khuyến mãi</p>
