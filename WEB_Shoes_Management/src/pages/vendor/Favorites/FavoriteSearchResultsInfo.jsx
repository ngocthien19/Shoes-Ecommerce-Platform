...
import { FiHeart, FiFilter, FiTrendingUp } from 'react-icons/fi'

export const FavoriteSearchResultsInfo = ({ totalItems, currentPage, limit, activeFiltersCount }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 w-24 h-24 bg-pink-500/5 rounded-full blur-2xl translate-y-1/2 -translate-x-1/2 pointer-events-none" />
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <motion.div variants={itemVariants} className="flex items-center gap-2">
              ...
              <div>
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Tổng số sản phẩm</p>
          ...
          {totalItems > 0 && (
            <motion.div variants={itemVariants} className="flex flex-col items-end gap-1">
              ...
              <div className="flex items-baseline gap-1.5">
                <span className="text-lg font-extrabold text-rose-500">{startItem}</span>
                <span className="text-sm text-gray-400">–</span>
                <span className="text-lg font-extrabold text-rose-500">{endItem}</span>
