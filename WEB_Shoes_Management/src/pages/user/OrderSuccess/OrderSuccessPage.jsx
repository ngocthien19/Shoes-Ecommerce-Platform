// src/pages/user/OrderSuccess/OrderSuccessPage.jsx
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50/50">
      ...
      <main className="flex-1 flex items-center justify-center p-4 py-12">
        <div className="bg-white ring ring-brand-primary/50 max-w-[480px] w-full rounded-[32px] p-8 md:p-10 shadow-sm border border-gray-100 flex flex-col items-center text-center animate-fadeIn">
  ...
  Đơn hàng của bạn đang được xử lý và sẽ sớm được giao đến bạn.
          ...
          <div className="bg-gray-50/80 w-full rounded-2xl p-5 space-y-3.5 mb-8 border border-gray-100">
            ...
            <div className="flex justify-between items-center text-sm">
              ...
              <span className="font-bold text-gray-900">{orderData.paymentMethod}</span>
            </div>
          </div>
