...
import { FiArrowLeft, FiSave, FiX, FiGrid, FiFolder } from 'react-icons/fi'

export const CategoryFormHeader = ({ isEditMode, onCancel, onSubmit, isSubmitting, hasErrors }) => {
  return (
    <motion.div
        ...
        <div>
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-xl bg-emerald-500/10 flex items-center justify-center shrink-0">
              {isEditMode ? (
                <FiFolder className="text-emerald-500" size={20} />
              ) : (
            ...
            <div>
              ...
              <p className="text-xs font-semibold text-gray-400 mt-1">
                {isEditMode ? 'Cập nhật thông tin danh mục' : 'Tạo danh mục sản phẩm mới trên hệ thống'}
              </p>
            </div>
          </div>
        </div>
