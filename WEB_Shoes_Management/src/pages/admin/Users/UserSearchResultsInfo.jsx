...
import { FiUsers, FiFilter, FiTrendingUp } from 'react-icons/fi'

export const UserSearchResultsInfo = ({ totalItems, currentPage, limit, activeFiltersCount }) => {
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Tổng người dùng</p>
