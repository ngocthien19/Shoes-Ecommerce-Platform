...
export const StoreFormHeader = ({ onCancel, onSubmit, isSubmitting, hasErrors }) => {
  return (
    <motion.div
        ...
        <div>
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-xl bg-emerald-500/10 flex items-center justify-center shrink-0">
              <FiPlus className="text-emerald-500" size={20} />
            </div>
            <div>
              <h2 className="text-2xl font-black text-gray-900 tracking-tight">Thêm cửa hàng mới</h2>
              <p className="text-xs font-semibold text-gray-400 mt-1">Tạo cửa hàng cho người dùng trên hệ thống</p>
            </div>
          </div>
        </div>
      </div>
