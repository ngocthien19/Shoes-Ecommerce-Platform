...
import { FiCheckSquare, FiCheckCircle, FiXCircle, FiX, FiDollarSign } from 'react-icons/fi'
import { FaBan } from 'react-icons/fa'

export const StoreBulkActionPanel = ({
  selectedCount,
  selectedStores,
  onBulkAction,
  onClearSelection
  ...
  const hasInactive = selectedStores.some(s => s.is_active === 0)
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <span className="text-sm font-semibold text-gray-700">
          Đã chọn <strong className="text-emerald-500 font-black px-1">{selectedCount}</strong> cửa hàng
        </span>
        <button
          type="button"
      ...
      <div className="flex flex-wrap items-center gap-2.5 w-full sm:w-auto justify-end">
        ...
        <button
          onClick={() => onBulkAction('commission')}
