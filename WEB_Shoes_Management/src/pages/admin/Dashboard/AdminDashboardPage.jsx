...
import { FiCalendar, FiFilter, FiChevronDown, FiCheck, FiTrendingUp, FiActivity } from 'react-icons/fi'
              ...
              {filterType === ANALYTICS_TYPES.CUSTOM && (
                ...
                >
                  <Input
                    ...
                    className="rounded-xl border-gray-200 text-gray-700 text-xs font-semibold py-5 cursor-pointer focus-visible:ring-emerald-500/20"
                  />
