...
import { FiFlag, FiFilter, FiTrendingUp } from 'react-icons/fi'

export const ReviewSearchResultsInfo = ({ totalItems, currentPage, limit, activeFiltersCount }) => {
              ...
              <div className="flex items-center gap-1 mt-0.5">
                <div className="w-12 h-1 bg-gray-100 rounded-full overflow-hidden">
                  <motion.div
                    ...
                    className="h-full rounded-full bg-gradient-to-r from-brand-primary to-amber-400"
                  />
                </div>
